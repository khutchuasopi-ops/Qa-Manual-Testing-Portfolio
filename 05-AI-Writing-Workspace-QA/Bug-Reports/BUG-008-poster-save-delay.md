# BUG-008 — Poster Save Is Delayed or Unresponsive
...
## Evidence
Screen recording showing the selected image, the Save Poster action, the delayed update, and the final poster state.

...
5. Provide the requested information when prompted.
...
In some cases, the Assistant displays an error related to the Draft or archive node.
...
## Evidence
Screen recording showing the writing request, Assistant response, and resulting Draft state or error message.

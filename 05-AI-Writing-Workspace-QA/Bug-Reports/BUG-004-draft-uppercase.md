# BUG-004 — Draft Editor Automatically Enters Text in Uppercase
...
## Actual Result
Lowercase text is automatically entered as uppercase while typing.

Example:
`ONCE UPON A TIME`

The text appears in uppercase immediately during text entry.

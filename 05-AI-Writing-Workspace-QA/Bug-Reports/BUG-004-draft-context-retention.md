# BUG-004 — New Draft Retains Context from a Previous Conversation
...
## Actual Result
The new Draft retains or references content from a previous independent document or conversation.

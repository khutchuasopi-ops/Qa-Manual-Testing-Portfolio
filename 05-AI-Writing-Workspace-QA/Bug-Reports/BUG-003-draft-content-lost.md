# BUG-003 — Draft Content Is Lost After Refresh
...
## Expected Result
Text entered in the Draft Editor should be saved automatically or persisted so that it remains available after refreshing the page.
